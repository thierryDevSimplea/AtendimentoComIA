...
const promptLines = [
  ...
  '- NUNCA repita uma pergunta cujo dado ja aparece no HISTORICO ou em "Dados coletados". Continue exatamente de onde parou, sem reiniciar o fluxo.',
  '- Envie UMA UNICA mensagem por resposta (nao divida em varias mensagens).',
  '- Se o cliente fizer uma pergunta fora do roteiro (ex: "ja identificou?"), responda-a brevemente e siga de onde parou.',
